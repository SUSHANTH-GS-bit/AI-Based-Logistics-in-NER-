...
# This allows your frontend teammates (React/Vue/HTML) to call this backend from different ports
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # Allows all origins during initial development
